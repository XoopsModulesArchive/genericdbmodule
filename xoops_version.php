...
// General settings
$modversion['config'][] = ['name' => $dirname . '_loaded_jq', 'title' => '_MI_' . $affix . '_LOADED_JQ', 'description' => '', 'formtype' => 'yesno', 'valuetype' => 'int', 'default' => '0'];
$modversion['config'][] = ['name' => $dirname . '_id_caption', 'title' => '_MI_' . $affix . '_ID_CAPTION', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'text', 'default' => 'ID'];
$modversion['config'][] = ['name' => $dirname . '_result_num', 'title' => '_MI_' . $affix . '_SEARCH_NUM', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'int', 'default' => '10'];
$modversion['config'][] = [
...
$modversion['config'][] = ['name' => $dirname . '_add_gids', 'title' => '_MI_' . $affix . '_ADD_GROUPS', 'description' => '', 'formtype' => 'group_multi', 'valuetype' => 'array', 'default' => ['1']];
$modversion['config'][] = ['name' => $dirname . '_add_guest', 'title' => '_MI_' . $affix . '_ADD_GUEST', 'description' => '', 'formtype' => 'yesno', 'valuetype' => 'int', 'default' => '0'];
$modversion['config'][] = ['name' => $dirname . '_his_gids', 'title' => '_MI_' . $affix . '_HIS_GROUPS', 'description' => '', 'formtype' => 'group_multi', 'valuetype' => 'array', 'default' => ['1']];
$modversion['config'][] = ['name' => $dirname . '_his_guest', 'title' => '_MI_' . $affix . '_HIS_GUEST', 'description' => '', 'formtype' => 'yesno', 'valuetype' => 'int', 'default' => '0'];
$modversion['config'][] = [
...
$modversion['config'][] = ['name' => $dirname . '_main_img_wd', 'title' => '_MI_' . $affix . '_DETAIL_IMAGE_WIDTH', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'int', 'default' => '300'];
$modversion['config'][] = ['name' => $dirname . '_list_img_wd', 'title' => '_MI_' . $affix . '_LIST_IMAGE_WIDTH', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'int', 'default' => '50'];
