...
$modversion['config'][] =
    array('name' => $dirname . '_add_gids', 'title' => '_MI_' . $affix . '_ADD_GROUPS', 'description' => '', 'formtype' => 'group_multi', 'valuetype' => 'array', 'default' => array('1'));
...
$modversion['config'][] =
    array('name' => $dirname . '_his_gids', 'title' => '_MI_' . $affix . '_HIS_GROUPS', 'description' => '', 'formtype' => 'group_multi', 'valuetype' => 'array', 'default' => array('1'));
...
$modversion['config'][] =
    array('name' => $dirname . '_main_img_wd', 'title' => '_MI_' . $affix . '_DETAIL_IMAGE_WIDTH', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'int', 'default' => '300');
$modversion['config'][] =
    array('name' => $dirname . '_list_img_wd', 'title' => '_MI_' . $affix . '_LIST_IMAGE_WIDTH', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'int', 'default' => '50');
