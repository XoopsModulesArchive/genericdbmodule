...
/**
 * Of the item information used on the management screen, the item information that matches the specified type is returned.
 *
...
/**
 * Check if the argument value consists of only single-byte alphanumerical characters (lowercase letters) and underscores.
 *
...
/**
 * Returns a language constant for the module management screen (_AM_).
 *
