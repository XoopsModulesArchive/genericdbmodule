...
$GLOBALS['xoopsOption']['template_main'] = $dirname . '_xgdb_his_search.tpl';
            ...
            if ('number' === $item_def['type'] && !isset($item_def['is_range_item'])) {
                ...
                if ('' !== $$item_name_or_over) {
                    if ('int' === $item_def['value_type']) {
                        ...
                        $where .= " $item_name >= '" . addslashes((float)$$item_name_or_over - 0.000001) . "' AND ";
                    }
                }
                if ('' !== $$item_name_or_less) {
                    if ('int' === $item_def['value_type']) {
                        ...
                        $where .= " $item_name <= '" . addslashes((float)$$item_name_or_less + 0.000001) . "' AND ";
                    }
                }
